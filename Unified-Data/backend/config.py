...
class Settings(BaseSettings):
    APP_NAME:    str  = "Unified Data – Meghalaya Focus Plus NLP-to-SQL"
    ...
    DATA_TABLE:         str = "Meghalaya_Chatbot"   # the unified farmer-payment table
    ...
    SECRET_KEY:   str = ""
    HOST:         str = "0.0.0.0"
    PORT:         int = 8000          # override via PORT in .env or env var
