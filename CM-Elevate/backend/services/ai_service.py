...
async def _call_with_retry(
    ...
    payload = {
        ...
        # (e.g. multi-tranche casts, district completion-rate breakdowns) mid-statement
        # → "Unbalanced parentheses". Every task here (SQL gen, intent, NL answer) is
        # deterministic and needs no extended thinking, so disable it (thinkingBudget=0)
        # — this frees the full token budget for output and lowers latency.
        "generationConfig": {
