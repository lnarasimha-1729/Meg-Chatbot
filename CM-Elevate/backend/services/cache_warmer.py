...
_WARM_QUERIES = [
    ...
    "How many applications are still not disbursed?",
    "What is the total subsidy disbursed scheme-wise?",
    "Show total disbursement by district.",
    "What is the total loan disbursed through LIFCOM vs Bank?",
    "How many applications per scheme?",
    "District-wise disbursement completion rate.",
    "How many applications were refused and why?",
